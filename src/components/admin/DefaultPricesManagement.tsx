    ...
    try {
      ...
      if (error.code === '23505') {
        toast({
          variant: "destructive",
          title: "Virhe",
          description: "Tämän lajin ja muodon yhdistelmälle on jo kilohinta määritelty."
        });
      } else {
        toast({
          variant: "destructive",
        ...
        <CardContent>
          {defaultPrices.length === 0 ? (
            <p className="text-muted-foreground text-center py-8">
              Et ole vielä määrittänyt kilohintoja. Lisää ensimmäinen kilohinta yllä olevalla lomakkeella.
            </p>
          ) : (
              ...
              {defaultPrices.map((price) => (
                ...
                >
                  <div className="flex items-center space-x-4">
                    <div>
                      <span className="font-medium">{getSpeciesLabel(price.species)}</span>
                      <span className="text-muted-foreground"> - {getFormLabel(price.form)}</span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-2">
                    {editingId === price.id ? (
                      <>
                        ...
                        <Button size="sm" onClick={() => handleSaveEdit(price.id)}>
                          Tallenna
                        </Button>
                      ...
                      <>
                        <button
                          ...
                          onClick={() => handleEdit(price.id, price.price_per_kg)}
                        >
