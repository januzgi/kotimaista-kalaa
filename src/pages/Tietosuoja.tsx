        ...
        <CardContent className="prose prose-sm max-w-none space-y-6">
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              - Käyttäjän nimi, sähköpostiosoite ja profiilikuvan URL (käyttäjän
              luodessa tilin) <br />- Asiakkaan puhelinnumero ja toimitusosoite
              (tilausta tehdessä) <br />- Sähköpostiosoite (saalisilmoitusten
              tilaajilta)
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              tiedot ja vaatia virheellisen tiedon korjaamista. Käyttäjät voivat
              päivittää omia tietojaan profiilisivun kautta.
            </p>
          </section>
