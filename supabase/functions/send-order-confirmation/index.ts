  ...
  try {
    ...
    const itemsHtml = order.order_items
      ...
      <tr>
        ...
        } (${item.product.form})</td>
        <td style="padding: 8px; border-bottom: 1px solid #eee; text-align: right;">${
          item.quantity
        } kg</td>
        <td style="padding: 8px; border-bottom: 1px solid #eee; text-align: right;">${item.product.price_per_kg.toFixed(
          2
        )} €/kg</td>
        <td style="padding: 8px; border-bottom: 1px solid #eee; text-align: right;"><strong>${(
          item.quantity * item.product.price_per_kg
        ).toFixed(2)} €</strong></td>
      </tr>
    `
      )
    ...
    const emailHtml = `
      ...
      <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
        <div style="background: #f8f9fa; padding: 20px; border-radius: 8px; margin-bottom: 20px;">
          ...
          <p style="margin: 10px 0 0 0; color: #666;">Tilaus #${order.id.slice(
            0,
            8
          )}</p>
        </div>
          ...
          <table style="width: 100%; margin-bottom: 20px;">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td style="padding: 8px; border-bottom: 1px solid #eee; text-align: right; font-weight: bold;">${deliveryFee.toFixed(
                  2
                )} €</td>
              </tr>
              `
              ...
              <tr style="background: #f8f9fa;">
                ...
                <td style="padding: 12px 8px; text-align: right; font-weight: bold; font-size: 16px; color: #000a43;">${totalPrice.toFixed(
                  2
                )} €</td>
              </tr>
            </tbody>
